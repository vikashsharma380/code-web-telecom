...
export default function SignupPage() {
  ...
  const handleVerifyOtp = async () => {
    try {
      const res = await axios.post("http://localhost:5000/api/auth/verify-otp", { mobile: phone, otp });
      if (res.data.success) {
        setOtpVerified(true);
        setError("");
        ...
        <div className="signup-content">
          <div className="signup-left">
            ...
            <ul className="feature-list">
              ...
              <li className="feature-item"><span className="feature-icon">✓</span> DTH & Data Card Services</li>
              <li className="feature-item"><span className="feature-icon">✓</span> Electricity Bill Payments</li>
              <li className="feature-item"><span className="feature-icon">✓</span> FASTag Recharge</li>
              <li className="feature-item"><span className="feature-icon">✓</span> Secure & Fast Transactions</li>
            </ul>
          </div>
          ...
          <div className="signup-right">
            ...
            <form className="signup-form" onSubmit={handleSignup}>
              <div className="form-group">
                ...
                <input type="text" id="name" className="form-input" placeholder="Enter your full name" value={name} onChange={(e) => setName(e.target.value)} required />
              </div>
              ...
              <div className="form-group">
                ...
                <input type="tel" id="phone" className="form-input" placeholder="Enter your phone number" value={phone} onChange={(e) => setPhone(e.target.value)} required />
                ...
                {otpVerified && <p style={{ color: "green", fontSize: "13px" }}>✅ WhatsApp verified</p>}
              </div>

              <div className="form-group">
                <label className="form-label" htmlFor="password">Password</label>
                <input type="password" id="password" className="form-input" placeholder="Create a password" value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="new-password" />
              </div>

              <div className="form-group">
                <label className="form-label" htmlFor="confirmPassword">Confirm Password</label>
                <input type="password" id="confirmPassword" className="form-input" placeholder="Confirm your password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required autoComplete="new-password" />
              </div>
              ...
              <div className="login-text">
                ...
                <span className="login-link" onClick={() => navigate("/login")}>Login here</span>
              </div>
            </form>
          </div>
        </div>
