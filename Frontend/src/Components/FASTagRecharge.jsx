...
export default function FASTagRecharge() {
  ...
  const handleRecharge = () => {
    if (!vehicleNumber || !fastagNumber || !bank || !amount) {
          ...
          <div style={styles.formSection}>
            <div style={styles.card}>
              ...
              <div style={styles.cardBody}>
                ...
                <div style={styles.formGroup}>
                  <label style={styles.label}>FASTag Number</label>
                  <input
                    type="text"
                ...
                <div style={styles.formGroup}>
                  ...
                  >
                    ...
                    <option value="Axis Bank FASTag">Axis Bank FASTag</option>
                    <option value="Paytm Payments Bank FASTag">
