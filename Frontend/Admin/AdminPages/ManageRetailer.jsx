...
{showEditModal && selectedUser && (
  <div style={modalStyles.overlay}>
    <div style={{ ...modalStyles.modal, width: "500px", maxHeight: "90vh", overflowY: "auto" }}>
      ...
      <div style={modalStyles.body}>
        ...
        <input
          ...
          onChange={(e) => setEditData({ ...editData, distributorName: e.target.value })}
        />
        ...
        <input
          ...
          onChange={(e) => setEditData({ ...editData, altMobile: e.target.value })}
        />
        ...
        <input
          ...
          onChange={(e) => setEditData({ ...editData, retailerType: e.target.value })}
        />
      ...
      <button
        ...
        onClick={async () => {
          try {
            await axios.put(`${API_URL}/api/users/${selectedUser._id}`, editData);
